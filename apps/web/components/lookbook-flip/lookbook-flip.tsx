...
export function LookbookFlip() {
  return (
    <section
      className="relative left-1/2 -mt-px w-screen -translate-x-1/2 border-t-0 bg-[linear-gradient(180deg,var(--bg)_0%,color-mix(in_srgb,var(--accent-warm)_80%,var(--bg))_100%)]"
